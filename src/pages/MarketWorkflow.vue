      ...
      <MDBCard>
        <MDBCardBody>
          <MDBCardText>
            ...
            <div class="row text-start">
              <div class="col-md-6">
                <dl class="row">
                  ...
                  <dd class="col-4">{{ t('version') }}:</dd>
                  <dt class="col-6">v{{ template.version }}</dt>

                  <dd class="col-4 col-md-4">{{ t('creator') }}:</dd>
                  <dt class="col-6 col-md-6">{{ creator.name }}</dt>

                  <dd class="col-4 col-md-4">{{ t('workflows_start') }}:</dd>
                  ...
                  <dd class="col-4 col-md-4">{{ t('workflows_finish') }}:</dd>
                  <dt class="col-6 col-md-6">
              ...
              <div class="col-md-6">
                <dl class="row">
                  <template v-for="(constant, index) in template.constants" :key="index">
                    <dd class="col-4 col-md-4" :class="[index == 0 ? 'mb-0' : '']"><span v-if="index == 0">{{ t('wf_constants') }}:</span></dd>
                    <dt class="col-6 col-md-6">{{ constant.name }}</dt>
                  </template>

                  <template v-for="(input, index) in template.attributes" :key="index">
                    <dd class="col-4 col-md-4" :class="[index == 0 ? 'mt-4 mb-0' : '']"><span v-if="index == 0">{{ t('wf_inputs') }}:</span></dd>
            ...
            <div class="row text-start">
              <div class="col-12">
                <h5 class="text-muted">{{ t('activities') }}</h5>
                <table class="table">
                  <thead>
                    <tr>
                      <th></th>
            ...
            <div v-if="transactions.length > 0" class="row text-start mt-3">
              <div class="col-12">
                <h5 class="text-muted">{{ t('wf_transitions') }}</h5>
                <table class="table">
                  <thead>
                    <tr>
                      <th></th>
