   ...
   <div class="d-flex flex-wrap justify-content-evenly align-items-stretch mb-5 mt-5">
      ...
      <div v-if="nearPrice" style="min-width: 280px;">
         ...
         <h6> {{ t("default.dao_funds") }} </h6>
            ...
            <span class="fs-2"><NumberFormatter :amount="dao.treasury.near * nearPrice"/></span> <span class="fs-5">USD</span>
         </div>
      </div>
      ...
      <div style="min-width: 280px;">
         ...
         <ul class="list-inline list-unstyled mb-0">
               ...
               <router-link :to="{ name: 'dao', params: {id: dao.wallet}, query: {page: 'voting' }}" class="text-reset">
                  <h2><i class="bi bi-bar-chart"></i><MDBBadge color="danger" pill notification>{{ dao.proposals.length }}</MDBBadge></h2>
               </router-link>
               </li>
               <li class="list-inline-item ms-1">
               <router-link :to="{ name: 'dao', params: {id: dao.wallet}, query: {page: 'documents' }}" class="text-reset">
                  <h2><i class="bi bi-files"></i><MDBBadge color="danger" pill notification>{{ dao.docs.files.length }}</MDBBadge></h2>
               </router-link>
               </li>
         </ul>
      </div>
