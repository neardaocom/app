        ...
        <section class="">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                    <!-- Links -->
                    <h6 class="text-uppercase mb-4 text-primary">{{ t('default.contacts') }}</h6>
                    <p><i class="bi bi-house text-primary me-3"/> {{ app_brand_address }}</p>
                    <p><i class="bi bi-envelope text-primary me-3"/> {{ app_brand_email }}</p>
                </div>
                <!-- Contacts -->
            </div>
            <!-- Grid row -->
